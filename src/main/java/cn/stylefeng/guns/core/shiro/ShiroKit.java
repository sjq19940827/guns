...
public class ShiroKit {
    ...
    public static boolean isAdmin() {
        ...
        System.out.println("ShiroKit.getUser().getRoleList()的值为"+ShiroKit.getUser().getRoleList());
        for (Long integer : roleList) {
            String singleRoleTip = ConstantFactory.me().getSingleRoleTip(integer);
            System.out.println("ConstantFactory.me().getSingleRoleTip(integer)的值为"+ConstantFactory.me().getSingleRoleTip(integer));
